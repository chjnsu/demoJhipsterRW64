...
public interface DepartmentRepository extends JpaRepository<Department, Long> {
    ...
    @Query( nativeQuery = false, value = "SELECT new com.vti.edu.railway.service.dto.DepartmentPlusDTO( d.id, d.departmentName as departmentName, concat(l.city, ' - ', c.countryName,r.regionName) as address) FROM Department d\n" +
