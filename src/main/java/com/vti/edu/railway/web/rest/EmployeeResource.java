...
/**
 * REST controller for managing {@link com.vti.edu.railway.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    @GetMapping("/employee/customAPI2")
    public List<Employee> customAPI2(){
        return employeeRepository.findEmployeeSearchStartWith();
    }
    @GetMapping("/employee/customAPI1")
    public List<Employee> customAPI1(){
        return employeeRepository.findEmployeeSearchIdStartWith();
    }
